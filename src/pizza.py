                    ...
                    if os.path.isfile(filename):
                        ...
                        for line in lines:
                            ...
                            if line.find("# Syntax:") >= 0:
                                ...
                                break
                        if not lineflag:
                            print("%s has no Syntax line" % words[1])
                        else:
                            print(line[2:], end=' ')
                        break
                if not fileflag:
...
if not silent:
    print("Loading tools ...")
if not silent and nodisplay:
    print("Display not available ... no GUIs")
...
try:
    from DEFAULTS import PIZZA_EXCLUDE
except BaseException:
    PIZZA_EXCLUDE = []
...
try:
    from DEFAULTS import PIZZA_SCRIPTS
except BaseException:
    PIZZA_SCRIPTS = []
